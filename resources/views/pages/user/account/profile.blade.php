                            ...
                            <div class="row">
                                <div class="col-xl-7 col-lg-7 col-md-12 profile__detail">
                                    <div class="profile__container content bg-white px-sm-3 px-2 py-sm-3 py-2 mb-5">
                                        <form action="{{ route('user-account-store-profile') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <div class="confirm-check mb-4">
                                                    ...
                                                    <select name="kota" id="kota"
                                                        class="p-1 @error('kota') is-invalid @enderror" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('alamat') is-invalid @enderror"
                                                    id="alamat" name="alamat" placeholder="alamat lengkap beserta rt/rw"
                                            ...
                                            <div class="form-group">
                                                <div class="confirm-check mb-4">
                                                    <label for="pendidikan_ahir" class="d-block">Pendidikan
                                                        Ahir</label>
                                                    <select name="pendidikan_ahir" id="pendidikan_ahir"
                                                        class="p-1" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('tagline') is-invalid @enderror"
                                                    id="tagline" name="tagline" placeholder="tagline dalam mencari pasangan"
                                                    rows="3">{{ old('tagline') }}</textarea>
                                                @error('tagline')
                                                    <div id="invalidCheck3Feedback" class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
