            ...
            <div class="col-12" style="background-color: white">
                ...
                <div class="row">
                    <div class="col-12 my-3 justify-content-center text-center">
                        <h3 class="text-muted text-center">DI DAMPINGIN OLEH {{ $pendamping->name }}</h3>
                        @if ($status1->status == $status2->status)
                            <form action="{{ route('admin-disable-taaruf') }}" class="mt-3" method="POST">
                                @csrf
                                ...
                                <button class="btn btn-primary">Disable Account User</button>
                            </form>
                        @endif
                    </div>
                </div>
